 ...
 * Decemeber 18th, 2018
 */
#ifndef TRADING_SYSTEM_PRODUCTS_HPP
#define TRADING_SYSTEM_PRODUCTS_HPP
...
public:
  ...
  // ctor for a bond
  Bond();
  Bond(string _productId, BondIdType _bondIdType, string _ticker, 
       float _coupon, date _maturityDate);
...
//
// Implementation of IRSwap class
...
#endif //TRADING_SYSTEM_PRODUCTS_HPP
